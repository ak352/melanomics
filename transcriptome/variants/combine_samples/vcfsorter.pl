...
# usage:
#
# vcfsorter.pl genome.dict myvcf.file sample_name> mynewvcf.file
#
######################################################
####Modified by Abhimanyu Krishna to include the ability to change sample names#######
...
vcfsorter.pl genome.dict myvcf sample_name > mynewvcf.file 2>STDERR
EOF
